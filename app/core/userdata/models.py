...
class Roles(models.Model):
    RoleName = models.CharField(max_length = 50, null=True, verbose_name="Roles")
...
class DetaRoles(models.Model):
    idRol = models.ForeignKey(Roles , default=1, null=True, on_delete = models.CASCADE, verbose_name ="Identificador de Rol")
    idUser = models.ForeignKey(DatosUser, default=1, null=True, on_delete = models.CASCADE)
